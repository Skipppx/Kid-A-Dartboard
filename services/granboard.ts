    ...
    if (hitsTaken < 7) {
      ...
      if (segmentID !== undefined) {
        ...
        if (hitsTaken > 6) {
          ...
          // alert('Out of Darts! ' + name + ', your score was: ' + totalScore +  '. \nThis has been added to the leaderboard. \n\nTo play with the same details, you can start a new game by throwing a dart. \n\nTo switch players, please refresh the page.');
      ...
      alert('Out of Darts! Want to play again?')
      hitsTaken = 1;
      totalScore = 0;
    }
  }
